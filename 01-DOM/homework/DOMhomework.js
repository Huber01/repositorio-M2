...
var span = document.querySelector('#createdBy'); // decaro una variable, y le pongo span, ya que esta definida como span.
 //newDiv.innerHTML('Aplicación creada por: Agustin' )

span.innerHTML = span.innerHTML + 'Agustin';
//como es un objeto, yo puedo acceder a ella como un objeto. entonces, al haber creado la variale span, le digo sumale agustin a lo que haya en innerHTML
...
function buildToDos(toDos) {
  ...
  //seria return todos.map(functino(todo,index))
}
